...
export {default as LocalisedString} from './LocalisedString'
export {default as InputText} from './InputText'
export {default as LocalisedSprite} from './LocalisedSprite'
export {default as Seat} from './Seat'
export {default as Name} from './Name'
export {default as Pricetag} from './Pricetag'
export {default as WaddleSeat} from './WaddleSeat'
