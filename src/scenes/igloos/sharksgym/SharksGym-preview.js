...
export default class SharksGym extends IglooScene {
    ...
    /** @returns {void} */
    _preload() {
        this.load.pack('sharksgym-pack', 'client/media/igloos/buildings/sprites/sharksgym/sharksgym-pack.json')
    }

    /** @returns {void} */
    _create() {
        // floor
        const floor = this.add.image(760, 480, 'sharksgym', 'bg')

        // fg
        const fg = this.add.image(760, 962.2032731464075, 'sharksgym', 'fg')
